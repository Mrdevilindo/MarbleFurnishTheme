        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="footer-col">
                    <h3 class="text-xl font-bold mb-4"><?php esc_html_e('About Us', 'marblecraft'); ?></h3>
                    ...
                    <div class="social-icons flex space-x-4">
                        ...
                        <a href="#" class="text-white hover:text-blue-400" aria-label="Twitter">
                ...
                <div class="footer-col">
                    ...
                    <address class="not-italic space-y-2">
                        <div class="flex items-start">
                            ...
                            <span><?php echo esc_html__('123 Marble St, Stone City', 'marblecraft'); ?></span>
                        </div>
                        <div class="flex items-start">
                            ...
                            <span><?php echo esc_html__('+1 (123) 456-7890', 'marblecraft'); ?></span>
                        </div>
                        <div class="flex items-start">
                            ...
                            <span><a href="mailto:info@marblecraft.com" class="hover:text-blue-400">info@marblecraft.com</a></span>
                        </div>
                    </address>
                </div>
            </div>
